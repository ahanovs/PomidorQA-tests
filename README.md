...
Проект покрывает **44 из 50 требований PomidorQA — 88%**.

| Уровень | Тестов | Что проверяется |
|---|---:|---|
| Unit | 10 | Пересечение временных слотов, формат времени в часовом поясе, минимальная длина пароля |
| API | 8 | Регистрация, ошибки бронирования, успешное бронирование и гонка за слот |
| E2E | 29 | Профиль, навыки, слоты, каталог, гостевой доступ, бронирование, отмена и список встреч |
| **Всего** | **47** | Unit + API + E2E |
